...
class ProcessController extends Controller
{
	public static function process($deposit)
    {
        ...
        $preferenceData = [
            ...
            'back_urls' => [
                'success' => route(...$successRedirectUrl),
                'pending' => '',
                'failure' => route(...$failedRedirectUrl),
            ],
    ...
    public function ipn(Request $request)
    {
        ...
        $deposit = Deposit::where('trx', $trx)->where('status', Status::PAYMENT_INITIATE)->orderBy('id', 'DESC')->with('donation.image')->first();
