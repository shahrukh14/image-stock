...
class ProcessController extends Controller
{
    ...
    public static function process($deposit)
    {
        ...
        $val['return'] = route(...$successRedirectUrl);
        $val['cancel_return'] = route(...$failedRedirectUrl);
    ...
    public function ipn()
    {
        ...
        if ($response == "VERIFIED") {
            $deposit = Deposit::where('trx', $_POST['custom'])->orderBy('id', 'DESC')->with('donation.image')->first();
