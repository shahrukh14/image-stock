            ...
            <div class="col-12">
                <div class="hero__container">
                    <form action="{{ route('search') }}" method="get">
                        ...
                        <div class="hero__content mx-auto">
                            ...
                            <div class="search-bar">
                                ...
                                <input type="text" name="filter" class="form-control form--control search-bar__input" placeholder="@lang('Search anything')...">
                            </div>
                            @if (count($tags))
                    ...
                    <div class="hero__image">
                        <img src="{{ getImage('assets/images/frontend/banner/' . @$content->data_values->right_image, '750x500') }}" alt="@lang('Banner')" class="hero__image-is">
                    </div>
                    <div class="hero__image-left">
                        <img src="{{ getImage('assets/images/frontend/banner/' . @$content->data_values->left_image, '1100x1140') }}" alt="@lang('Banner')" class="hero__image-is">
                    </div>
                </div>
            </div>
        </div>
