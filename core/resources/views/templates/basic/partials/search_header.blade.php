        ...
        <div class="header-top__content">
            <nav class="navbar navbar-expand-lg navbar-dark">
                <a class="logo" href="{{ route('home') }}">
                    <img class="img-fluid logo__is" src="{{ getImage(getFilePath('logoIcon') . '/logo.png') }}" alt="@lang('Logo')">
                </a>
                    ...
                    <ul class="list primary-menu">
                        ...
                        <li class="nav-item has-sub">
                            ...
                            <ul class="primary-menu__sub">
                                ...
                                <li>
                                    <a class="t-link primary-menu__sub-link" href="{{ route('images', ['scope' => 'featured']) }}">@lang('Featured')</a>
                                </li>
                                <li>
                                    <a class="t-link primary-menu__sub-link" href="{{ route('images', ['scope' => 'popular']) }}">@lang('Popular')</a>
                                </li>

                                <li>
                                    <a class="t-link primary-menu__sub-link" href="{{ route('images', ['scope' => 'most-download']) }}">@lang('Most downloads')</a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item has-sub">
                            <a class="primary-menu__link" href="javascript::void(0)">@lang('Category')</a>
                            <ul class="primary-menu__sub">
                                @foreach ($categories as $category)
                                    <li>
                                        <a class="t-link primary-menu__sub-link" href="{{ route('search', ['type' => 'image', 'category' => $category->slug]) }}">
                                            {{ __($category->name) }}
                                        </a>
                                    </li>
                                @endforeach
...
<div class="header-secondary">
    <div class="container-fluid">
        ...
        <div class="primary-search">
            <!-- Logo  -->
            <a class="logo" href="{{ route('home') }}">
                <img class="img-fluid logo__is" src="{{ getImage(getFilePath('logoIcon') . '/logo_dark.png') }}" alt="@lang('logo')">
            </a>
            <!-- Logo End -->
            <div class="search-bar">
                ...
                <input class="form-control form--control search-bar__input search-input" type="search" value="{{ request()->filter ?? '' }}" placeholder="@lang('Search anything')..">
            </div>
