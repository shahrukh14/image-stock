    ...
    <div class="filter-sidebar__body" data-simplebar>
        <ul class="list" style="--gap: 0.5rem">
                ...
                <li>
                    ...
                    <ul class="list list--row flex-wrap align-items-center">
                        ...
                        @foreach ($colors as $color)
                            <li>
                                <span class="color-selector search-param" id="color-{{ $color->id }}" data-param="color" data-param_value="{{ $color->color_code }}" data-search_type="single" style="background: #{{ $color->color_code }};border: 1px solid @if ($color->color_code != 'ffffff' && $color->color_code != 'fff') #{{ $color->color_code }}; @else #bac8d3 @endif"></span>
                            </li>
                        @endforeach
                    </ul>
                </li>
            ...
            <li>
                ...
                <ul class="list list--row flex-wrap align-items-center pb-3">
                    <li>
                        <span class="filter-btn__is search-param" data-param="tag" data-search_type="single" data-param_value="all">@lang('All')</span>
                    </li>
                    @if (request()->tag && !in_array(request()->tag, $tags))
                        <li>
                            <span class="filter-btn__is search-param" data-param="tag" data-search_type="single" data-param_value="{{ request()->tag }}">{{ __(request()->tag) }}</span>
                        </li>
                    @endif
                    @foreach ($tags as $tag)
                        <li>
                            <span class="filter-btn__is search-param" data-param="tag" data-search_type="single" data-param_value="{{ $tag }}"> {{ __($tag) }} </span>
                        </li>
                    @endforeach
            ...
            <li>
                ...
                <ul class="list list--row flex-wrap align-items-center pb-3">
                    <li>
                        <span class="filter-btn__is search-param" data-param="extension" data-search_type="single" data-param_value="all">@lang('All')</span>
                    </li>
                    @foreach ($extensions as $text)
                        <li>
                            <span class="filter-btn__is search-param" data-param="extension" data-search_type="single" data-param_value="{{ $text }}"> {{ __(strtoupper($text)) }} </span>
                        </li>
                    @endforeach
