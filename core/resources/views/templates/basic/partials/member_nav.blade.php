            ...
            <div class="col-12">
                <div class="user-profile__content">
                    ...
                    <div class="user-profile__img">
                        <img class="user-profile__img-is" id="profilePicture" src="{{ getImage(getFilePath('userProfile') . '/' . $member->image, null, 'user') }}" alt="@lang('member')">
                        @if ($member->id == @$user->id)
        ...
        <div class="row">
            <div class="col-12">
                <div class="tab-menu__content">
                    <a class="tab-menu__link {{ menuActive('member.images') }}" href="{{ route('member.images', $member->username) }}"> @lang('IMAGES') </a>
                    <a class="tab-menu__link {{ menuActive('member.followers.followings') }}" href="{{ route('member.followers.followings', $member->username) }}"> @lang('FOLLWERS & FOLLWINGS') </a>
                    <a class="tab-menu__link {{ menuActive('member.collections') }}" href="{{ route('member.collections', $member->username) }}"> @lang('COLLECTION') </a>
                </div>
            </div>
        </div>
    </div>
