                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="price-card price-card--base plan-card" data-monthly_price="{{ showAmount($plan->monthly_price) }}" data-yearly_price="{{ showAmount($plan->yearly_price) }}">
                                ...
                                <ul class="list">
                                    <li>
                                        <div class="list list--row align-items-end" style="--gap: 0.2rem">
                                            <h1 class="price-card__price plan-price m-0">{{ __(showAmount($plan->monthly_price)) }}</h1>
                            ...
                            <div class="price-card__footer">
                                <button class="base-btn rounded-pill w-100 purchase-btn" data-current="{{ auth()->user()?->purchasedPlan?->plan_id == $plan->id }}" data-daily_limit="{{ $plan->dailyLimitText }}" data-id="{{ $plan->id }}" data-monthly_limit="{{ $plan->monthlyLimitText }}" data-plan_name="{{ __($plan->name) }}" type="button">
                                    @lang('Purchase Now')
                                </button>
                            </div>
                        </div>
