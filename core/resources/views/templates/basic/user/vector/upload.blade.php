                        ...
                        <form class="resourceUploadForm" enctype="multipart/form-data" method="post">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <div class="photo-upload-area">
                                            <div class="file-upload">
                                                <div class="image-upload-wrap @if (@$vector) d-none @endif">
                                                    <input class="file-upload-input validate" id="image-lavel" name="photo" type='file' @if (!@$vector) required @endif accept=".png,.jpeg,.jpg" onchange="readURL(this);">
                                                    <div class="drag-text">
                                                        <label class="title" for="image-lavel">@lang('Drag and drop a file or click the button below')</label>
                                                    </div>
                                                </div>
                                                <div class="file-upload-content @if (@$vector) d-block @endif">
                                                    <img class="file-upload-image" src="{{ @$vector ? imageUrl(getFilePath('stockImage'), $vector->image_name) : '' }}" alt="@lang('your vector')">
                                                </div>
                                                <button class="base-btn w-100 upload-btn mt-3" type="button">@lang('Upload Thumb vector Here')</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row g-0">
                                            <div class="col-12 mb-3">
                                                ...
                                                <input class="form-control form--control" name="title" type="text" value="{{ old('title', @$vector->title) }}" required>
                                                <input name="file_type" type="hidden" value="vector">
                                            </div>
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form--select">
                                                    <select class="form-select form--control select2-tokenize" name="category[]" multiple="multiple" required>
                                                        @foreach ($categories as $category)
                                                            <option value="{{ $category->id }}"  @selected(@$vector &&  in_array($category->id, $vector->category_id))> {{ __($category->name) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form--select">
                                                    <select class="form-select form--control select2-tokenize" name="extensions[]" multiple="multiple" required>
                                                        @foreach ($extensions as $ext)
                                                            <option value="{{ $ext }}" @selected(@$vector && in_array($ext, $vector->extensions))>
                                            ...
                                            <div class="col-12 mb-3">
                                                ...
                                                <div class="form--select">
                                                    <select class="form-select form--control select2-auto-tokenize" name="tags[]" multiple="multiple" required>
                                                        @foreach (old('tags', $vector->tags ?? []) as $oldTag)
                                ...
                                <div class="col-12 mb-3">
                                    <div class="card p-3">
                                        <div class="priceNewElement">
                                            ...
                                            @forelse (@$vector->files ?? []  as $key => $file)
                                            
                                                @if($vector->files)
                                                <h5 class="pb-sm-1 my-1">@lang('Thumb vectors')</h5>
                                                <div class="row">
                                                    @foreach ($vector->thumb_resource ?? [] as $thumb)
                                                    <div class="col-md-2">
                                                        <img alt="{{$vector->title}}"    src="{{ imageUrl(getFilePath('stockImage'), $thumb, null, true) }}" class="image background-image">
                                                    </div>
                                                    @endforeach
                                                </div>
                                                @endif
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                <input class="form-control form--control fileInput" name="old_file[{{ $file->id }}][file]" type="file" @if (!@$vector) required @endif accept=".zip,.7z,.rar,.tar,.wim">
                                                                <a class="input-group-text" href="{{ route('user.vector.download.file', $file->id) }}">
                                                ...
                                                <div class="extraPriceElement border-bottom">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input class="form-control form--control resolutionInput" name="resolution[]" type="text" value="{{ old('resolution', @$vector->resolution) }}" placeholder="@lang('e.g. 600x1200 px')" required>
                                                        </div>

                                                        <div class="col-md-6 mb-3">
                                                            <label class="form-label">@lang('Zip File')</label>
                                                            <input class="form-control form--control fileInput" name="file[]" type="file" @if (!@$vector) required @endif accept=".zip,.7z,.rar,.tar,.wim">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label class="form-label">@lang('Status')</label>
                                                            <div class="form--select">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <div class="form--select">
                                                                <select class="form-select is_free_select" name="is_free[]" required>
                                                                    <option value="0" @selected(old('is_free', @$vector->is_free) == 0)>
                                                                        @lang('Premium')
                                                                    </option>
                                                                    <option value="1" @selected(old('is_free', @$vector->is_free) == 1)>
                                                                        @lang('Free')
                                                                    </option>
                                                        ...
                                                        <div class="price-div col-6 mb-3">
                                                            ...
                                                            <div class="input-group input--group">
                                                                <input class="form-control form--control image-price priceInput" name="price[]" type="number" value="{{ old('price', showAmount(@$vector->price)) }}" max="{{ $general->image_maximum_price }}" min="0" step="any">
                                                                <span class="input-group-text">
                                                                    {{ __($general->cur_text) }}
                                                                </span>
                                                            </div>
                                                        ...
                                                        <div class="price-div col-6 mb-3">
                                                            ...
                                                            <div class="input-group input--group">
                                                                <input class="form-control form--control image-price priceInput" name="ex_price[]" type="number" value="{{ old('ex_price', showAmount(@$vector->ex_price)) }}" max="{{ $general->image_maximum_price }}" min="0" step="any">
                                                                <span class="input-group-text">
                                                                    {{ __($general->cur_text) }}
                                                                </span>
                                                            </div>
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <textarea class="form-control form--control nicEdit" id="description" name="description" rows="6">{{ old('description', @$vector->description) }}</textarea>
...
@push('script')
    <script>
        ...
        $('.resourceUploadForm').on('submit', function(e) {
            ...
            let isUpdate = {{ @$vector->id ?? 0 }};
            let url = `{{ @$vector->id ? route('user.vector.update', $vector->id) : route('user.vector.store') }}`;
                ...
                <div class="extraPriceElement border-bottom">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input @if (!@$vector) required @endif accept=".zip,.7z,.rar,.tar,.wim" class="form-control form--control fileInput" name="file[]" type="file">
                        </div>
                        <div class="col-md-6 mb-3">
                                <label class="form-label">@lang('Status')</label>
                                <div class="form--select">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form--select">
                                <select class="form-select is_free_select" name="is_free[]" required>
                                    <option @selected(old('is_free', @$vector->is_free) == 0) value="0">
                                        @lang('Premium')
                                    </option>
                                    <option @selected(old('is_free', @$vector->is_free) == 1) value="1">
                                        @lang('Free')
                                    </option>
