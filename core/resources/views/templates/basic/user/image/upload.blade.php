                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                <input class="form-control form--control fileInput" name="old_file[{{ $file->id }}][file]" type="file" @if (!@$image) required @endif accept=".zip,.7z,.rar,.tar,.wim">
                                                ...
                                                <div class="extraPriceElement border-bottom">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 mb-3">
                                                            ...
                                                            <input class="form-control form--control resolutionInput" name="resolution[]" type="text" value="{{ old('resolution', @$image->resolution) }}" placeholder="@lang('e.g. 600x1200 px')" required>
                                                        </div>

                                                        <div class="col-md-6 mb-3">
                                                            <label class="form-label">@lang('Zip File')</label>
                                                            <input class="form-control form--control fileInput" name="file[]" type="file" @if (!@$image) required @endif accept=".zip,.7z,.rar,.tar,.wim">
                                                        </div>
                                                        <div class="col-md-6 mb-3">
                                                            <label class="form-label">@lang('Status')</label>
                                                            <div class="form--select">
