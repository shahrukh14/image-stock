    ...
    <div id="invoiceholder">
        <div id="invoice">
            <div id="invoice-top">
                <div class="logo">
                    <a href="{{ route('home') }}">
                        <img src="{{ getImage(getFilePath('logoIcon') . '/logo_dark.png') }}" alt="image">
                    </a>
                </div>
                <div class="title">
                ...
                <div id="table">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr class="tabletitle">
                                <td colspan="3">
                                    <h2 class="me-2 m-0 p-1 text-end">@lang('Total:') {{ showAmount(@$transaction->amount) }} {{ __($general->cur_text) }}</h2>
                                </td>
                            </tr>
                        </tbody>
                    </table>
