            ...
            @if (request()->type != 'collection' && $categories->count() > 1)
                <div class="search-category">
                    <div class="search-category__list">
                        <button class="search-category__btn search-param" data-param="category" data-param_value="" data-search_type="single">@lang('All Category')</button>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="tab-menu__content">
                                <a class="tab-menu__link search-images @if (request()->type == 'image') active @endif" href="javascript:void(0)"> <i class="las la-image"></i> @lang('Images') ({{ $imageCount }}) </a>

                                <a class="tab-menu__link search-collections @if (request()->type == 'collection') active @endif" href="javascript:void(0)"> <i class="las la-folder-plus"></i> @lang('Collections') ({{ $collectionCount }}) </a>
                            </div>
                        </div>
                    </div>
                </div>
