                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="javascript:void(0)" class="dropdown-item cuModalBtn editBtn" data-modal_title="@lang('Update Reason')" data-resource="{{ $reviewer }}"><i class="las la-pencil-alt"></i> @lang('Edit')</a>

                                                @if ($reviewer->status == 1)
                                                    <a href="javascript:void(0)" class="dropdown-item confirmationBtn" data-question="@lang('Are you sure, you want to banned this reviewer?')" data-action="{{ route('admin.reviewers.status', $reviewer->id) }}"><i class="las la-ban"></i> @lang('Ban')</a>

                                                    <a href="{{ route('admin.reviewers.login', $reviewer->id) }}" class="dropdown-item" target="_blank"><i class="las la-sign-in-alt"></i> @lang('Login')</a>
                                                @else
                                                    <a href="javascript:void(0)" class="dropdown-item confirmationBtn" data-question="@lang('Are you sure, you want to banned this reviewer?')" data-action="{{ route('admin.reviewers.status', $reviewer->id) }}"><i class="las la-check-circle"></i> @lang('Unban')</a>
                                                @endif
