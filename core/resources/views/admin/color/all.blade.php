                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-end flex-wrap gap-2">
                                                <button class="btn btn-outline--primary cuModalBtn editBtn btn-sm" data-modal_title="@lang('Update Color')" data-resource="{{ $color }}">
                                                    <i class="las la-pen"></i>@lang('Edit')
                                                </button>
                                                <button class="btn btn-outline--danger btn-sm confirmationBtn" data-action="{{ route('admin.color.delete', $color->id) }}" data-question="@lang('Are you sure to delete this color?')">
