            ...
            <ul class="sidebar__menu">
                ...
                {{-- <li class="sidebar-menu-item sidebar-dropdown">
                    <a class="{{ menuActive('admin.donation*', 3) }}" href="javascript:void(0)">
                        ...
                        @if (0 < $pendingDonationCount)
                            <span class="menu-badge pill bg--danger ms-auto">
                                <i class="fa fa-exclamation"></i>
                            </span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{ menuActive('admin.donation*', 2) }}">
                        <ul>
                            <li class="sidebar-menu-item {{ menuActive('admin.donation.pending') }}">
                                <a class="nav-link" href="{{ route('admin.donation.pending') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Donations')</span>
                                    @if ($pendingDonationCount)
                                        <span class="menu-badge pill bg--danger ms-auto">{{ $pendingDonationCount }}</span>
                                    @endif

                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.donation.reject') }}">
                                <a class="nav-link" href="{{ route('admin.donation.reject') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Rejected Donations')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.donation.paid') }}">
                                <a class="nav-link" href="{{ route('admin.donation.paid') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Paid Donations')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.donation.log') }}">
                                <a class="nav-link" href="{{ route('admin.donation.log') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                    ...
                    <div class="sidebar-submenu {{ menuActive('admin.report*', 2) }}">
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.report.download.log') }}">
                                <a class="nav-link" href="{{ route('admin.report.download.log') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Download Log')</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item {{ menuActive('admin.report.plan.purchased') }}">
                                <a class="nav-link" href="{{ route('admin.report.plan.purchased') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.report.contributor.earnings') }}">
                                <a class="nav-link" href="{{ route('admin.report.contributor.earnings') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{ menuActive('admin.report.user.image.collections') }}">
                                <a class="nav-link" href="{{ route('admin.report.user.image.collections') }}">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.sitemap.index') }}">
                    <a class="nav-link" href="{{ route('admin.sitemap.index') }}">
                        <i class="menu-icon las la-sitemap"></i>
                        <span class="menu-title">@lang('Upload Sitemap')</span>
                    </a>
                </li>
