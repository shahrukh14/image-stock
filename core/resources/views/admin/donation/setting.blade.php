                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control iconPicker icon" name="icon" type="text" value="{{ @gs('donation_setting')?->icon }}" autocomplete="off" required>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input class="form-control" name="amount" type="number" value="{{ @gs('donation_setting')?->amount }}" required step="any">
